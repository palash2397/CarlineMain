...
<head>
    ...
    <title>Reset Your Password - Carline</title>
    <style>
        body {
        ...
        .header {
            ...
            padding: 30px 20px;
            text-align: center;
            border-bottom: 3px solid #e94560; /* Accent red */
        }
        .header h1 {
            color: #ffffff;
            margin: 0;
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>We received a request to reset your Carline account password. Please use the verification code below to set a new password:</p>
            ...
            <p class="warning">If you did not request a password reset, you can safely ignore this email. Your password will remain unchanged.</p>
        </div>
        <div class="footer">
